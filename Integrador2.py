...
def solo_letras(mensaje):
    while True:
        ...
        if nombre.isalpha():
            ...
            print("Por favor, utilice solo letras de A hasta Z.")
...
def pedido():
    ...
    while True:
        ...
        if confirmar == "Y":
            ...
            print("Por favor, ingrese 'Y' para confirmar o 'N' para cancelar.")
...
while ejecutar_programa:
    ...
    # Menú
    print(f"Hamburguesas IT\nEncargad@ -> {nombre}\nRecuerde, siempre hay que recibir al cliente con una sonrisa :)")
    while True:
        # Opciones
